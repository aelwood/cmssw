...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring( 
        'file:///afs/cern.ch/work/a/aelwood/alphat/trigger/hltSkimNew.root',
    )
...
process.HLTSusyExoValSeq = cms.Sequence(process.SUSY_HLT_HT200_alphaT0p57 + process.SUSY_HLT_HT250_alphaT0p55 + process.SUSY_HLT_HT300_alphaT0p53 + process.SUSY_HLT_HT350_alphaT0p52 + process.SUSY_HLT_HT400_alphaT0p51)
